...
public class BasePagerAdapter<T extends Fragment> extends PagerAdapter {

    private FragmentManager mManager;
    private List<T>  mFragments;
    private List<String>    mTitle;

    public BasePagerAdapter(FragmentManager manager, List<T> data) {
        this(manager, data, null);
    }

    public BasePagerAdapter(FragmentManager manager, List<T> data, List<String> title) {
        mManager = manager;
        mFragments = data;
        mTitle = title;
    }
